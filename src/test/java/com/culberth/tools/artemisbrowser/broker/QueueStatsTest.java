...
/**
 * {@link QueueStats#browseName()} is the one piece of Artemis addressing this app cannot get wrong without the symptom
 * being "that queue is always empty" rather than an error.
 */
